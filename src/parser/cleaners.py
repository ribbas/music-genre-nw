...
from ..util.typealias import ColumnDict, IntTuple, WrangledData
...
class DataCleaner:
    ...
    def __init__(self) -> None:
        ...
        self.raw_file_data: list[dict[str, ColumnDict]] = []
        self.wrangled_data: list[dict[str, str | WrangledData]] = []
    ...
    def load_raw_data(self, raw_file_data: list[dict[str, ColumnDict]]) -> None:

        self.raw_file_data = raw_file_data

    def get_wrangled_data(
        self,
    ) -> list[dict[str, str | WrangledData]]:
    ...
    def normalize(self) -> None:
        ...
        genre_key: str
        genre_values_list: ColumnDict
        normalized_values: dict[str, WrangledData]
    ...
    def normalize_category_data(
        self, genre_key: str, genre_data: ColumnDict
    ) -> tuple[str, dict[str, WrangledData]]:

        normalized_category_data: dict[str, WrangledData] = {}
    ...
    @staticmethod
    def consolidate_origin_dates(origin_date_list: set[IntTuple], ix: int) -> int:
